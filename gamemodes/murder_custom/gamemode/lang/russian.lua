...
pt.teamMoved = "{player} был перемещён в команду {team}"
pt.teamMovedAFK = "{player} был перемещён в команду {team} за бездействие"

pt.spectateFailed = "Вы не можете наблюдать. Вы живы."

pt.murdererDisconnect = "Убийца вышел из игры в ярости!"
...
pt.roundStartsInTime = "Раунд начнётся через {seconds}"
...
pt.scoreboardActionUnmute = "Снять заглушение"
pt.scoreboardActionViewProfile = "Просмотреть профиль"

pt.endroundMurdererQuit = "Свидетели победили! Убийца вышел из игры"
...
pt.ttt_tbut_single  = "Одноразово"
pt.ttt_tbut_reuse   = "Многоразово"
pt.ttt_tbut_retime  = "Многоразовое: через {num} сек"
pt.ttt_tbut_waittime  = "Многоразовое: через {timesec}"
pt.ttt_tbut_help    = "Нажмите {key} для активации"
